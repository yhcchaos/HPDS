#ifndef __YHCHAOS_UTIL_HASH_UTIL_H__
#define __YHCHAOS_UTIL_HASH_UTIL_H__
...
void hexstring_funrom_data(const void *data, size_t len, char *output);
std::string hexstring_funrom_data(const void *data, size_t len);
...
std::string data_funrom_hexstring(const std::string &data);
